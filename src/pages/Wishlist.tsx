...
const Wishlist = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0D0C29]">
      <Header />
      <div className="py-8">
        <div className="container mx-auto px-4">
          ...
          {wishlistItems.length === 0 ? (
            <div className="text-center text-white py-16">
              <Heart className="h-24 w-24 mx-auto mb-4 text-gray-400" />
              <h3 className="text-2xl font-bold mb-2">Your wishlist is empty</h3>
              <p className="text-gray-300 mb-6">Start adding items you love to see them here</p>
              <Button 
                onClick={() => navigate('/products')}
                className="bg-gradient-to-r from-[#1F1E39] to-yellow-500 text-white hover:from-[#2A2857] hover:to-yellow-600"
              >
                Browse Products
              </Button>
            </div>
                  ...
                  <CardContent className="p-0">
                    <div className="relative overflow-hidden">
                      ...
                      <Button 
                        ...
                        className="absolute top-4 right-4 bg-white/80 hover:bg-red-100 transition-all duration-300 text-red-500"
                      >
