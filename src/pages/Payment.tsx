    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-yellow-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Add some beautiful jewelry to your cart to proceed with payment</p>
          <Button 
            onClick={() => navigate('/')}
      ...
      <div className="bg-[#0D0C29] text-white py-6">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-4">
            ...
            <p className="text-yellow-200 mt-2">Complete your payment securely</p>
          </div>
        </div>
      </div>
